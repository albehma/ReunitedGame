...
/**
Gestisco il gioco del secondo livello del labirinto
...
public class Livello2_Labirinto extends AppCompatActivity {

    int r ;  //imposto variabili che gestiscono riga e colonna
    int c ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lab1[1][0] = new Labirinto(267,120,false);
        lab1[2][0] = new Labirinto(445,120,true);
        lab1[3][0] = new Labirinto(622,120,true);
        lab1[4][0] = new Labirinto(800,120,true);
        lab1[0][1] = new Labirinto(90,360,true);
        lab1[1][1] = new Labirinto(267,360,false);
        lab1[2][1] = new Labirinto(445,360,true);
        lab1[3][1] = new Labirinto(622,360,false);
        lab1[4][1] = new Labirinto(800,360,true);
        lab1[0][2] = new Labirinto(90,600,true);
        lab1[1][2] = new Labirinto(267,600,false);
        lab1[2][2] = new Labirinto(445,600,true);
        lab1[3][2] = new Labirinto(622,600,false);
        lab1[4][2] = new Labirinto(800,600,true);
        lab1[0][3] = new Labirinto(90,840,true);
        lab1[1][3] = new Labirinto(267,840,true);
        lab1[2][3] = new Labirinto(445,840,true);
