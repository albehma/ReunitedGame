...
//Classe principale
public class Principale_Memory extends AppCompatActivity {

    //id delle immagini nell'activity_main
    ImageView iv_11, iv_12, iv_13, iv_14, iv_21, iv_22, iv_23, iv_24, iv_31, iv_32, iv_33, iv_34, iv_41, iv_42, iv_43, iv_44;//id delle immagini nell'activity_main
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int theCard = Integer.parseInt(ss);
    ...
    private void checkEnd(){
        ...
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Principale_Memory.this);
            alertDialogBuilder
                    .setMessage("Congrats!")
                    .setCancelable(false)
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), Principale_Puzzle15.class);
